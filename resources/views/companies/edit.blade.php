...
<form method="POST" action="{{ route('company.update', [$company]) }}">
        ...
        <input class="form-control"  type="text" name="company_type" value='{{$company->company_type}}'/>
         <input class="form-control" type="text" name="company_description" value='{{$company->company_description}}'/>
